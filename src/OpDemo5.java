...
public class OpDemo5 {
	...
	public static void main(String[] args) {
		// 논리 연산자 
		// && || ! 
		// 두 이상의 비교 연산 결과를 합쳐서 최종 결과를 획득할 때 사용되는 연산자다. (!은 죄외)
		// 논리연산자의 좌항/우항에는 불린값이 오거나, 식의 연산결과가 불린값인 것만 위치할 수 있습니다.
		
		// 자동차 유상처리 판정하기
		// 주행거리가 10만 km 이상이거나 사용기간이 3년 이상인 차량은 유상수리 대상이다.
		// 논리합
		int distance = 50000;
		int usedYear = 2;
		...
		// 사은품 지급 기준
		// 고객의 등급(1,2,3등급이 있음)이 2등급 보다 높거나 같고, 구매금액이 10만원 이상인 경우 사은품 지급 대상이다.
		// 논리곱
		int grade = 3;
		...
		// 장학금 지급 기준
		// 국어, 영어, 수학점수의 평균이 90점 이상이고, 국어점수가 95점 이상인 경우 장학금 지급 대상이다. 
		...
		System.out.println("포인트 지급여부 판정결과");
