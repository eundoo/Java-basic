...
public class ArrayDemo1 {
	...
	public static void main(String[] args) {
		 ...
		 *  int[] numbers		정수 배열객체의 주소값을 담는 변수 numbers를 생성한다.
		 *  
		 *  int[] numbers = new int[5];
		 *  정수 5개 저장할 수 있는 배열 객체를 생성하고, 그 배열객체의 주소값을 변수 numbers에 
		 *  대입한다.
		 *  numbers변수는 생성된 배열객체를 참조하는 변수다.
		 */
		int[] numbers = new int[5];
		...
		for (int i=0; i<3; i++) {
			...
			System.out.println("학과명: " +deptName); //null이 출력됨
		}
